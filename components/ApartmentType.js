    ...
    <div className="bg-[#e5e5e5] mt-[112px] lg:mt-[136px]">
      <div className="w-full xl:max-w-[1150px] 2xl:max-w-[1300px] lg:pt-[75px] lg:pb-[125px] pt-[48px] pb-[64px] mx-auto px-[20px] sm:px-[25px]">
        ...
        <div className="min-[860px]:w-[810px] lg:w-full min-[860px]:mx-auto lg:flex-col min-[600px]:flex grid grid-cols-1 gap-5 items-center justify-center sm:gap-[25px] lg:gap-[40px]">
          <div className="bg-[#fff] rounded-[40px] min-[600px]:w-1/2 items-center justify-center mx-auto lg:flex lg:w-full">
            <div className="hidden lg:block lg:w-1/2">
              <img
                src="/images/apartment-types-1.png"
                alt=""
                className="w-full h-[468px]"
              />
            </div>
            <div className="w-full max-[600px]:max-w-[400px] lg:w-1/2 bg-[#fff] rounded-[40px]">
          ...
          <div className="bg-[#fff] rounded-[40px] min-[600px]:w-1/2 items-center justify-center mx-auto lg:flex lg:flex-row-reverse lg:w-full">
            <div className="hidden lg:block lg:w-1/2">
              <img
                src="/images/apartment-types-2.png"
                alt=""
                className="w-full h-[468px]"
              />
            </div>
